...
function lift() {
	...
	if (typeof(liftstop2) == 'undefined') { 
		...
		setTimeout("document.querySelector('.message p').innerHTML = 'Так, посмотрим... Нужно выставить контакты в рабочее положение для перезапуска...<br>Рядом со вторым рядом, на панели накорябана цифра 4 и надпись &quot;Потом первым выравнивай второй до 6...&quot;.'", 4000);
